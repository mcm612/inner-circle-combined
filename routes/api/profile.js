...
router.post(
	...
	async (req, res) => {
		...
		if (req.file) profileFields.profilephoto = url + '/public/img/users/' + req.file.filename;
...
router.delete('/', auth, async (req, res) => {
	try {
		...
		// Remove user markets
		await Market.deleteMany({ creator: req.user.id });
		// Remove profile
...
// @access   Private
// @misc     Must have profile set-up first
router.put(
	'/experience',
	[
		auth,

...
export const GET_USER_MARKET_LIST = 'GET_USER_MARKET_LIST';
export const GET_ALL_MARKETS = 'GET_ALL_MARKETS';
export const GET_SINGLE_MARKET = 'GET_SINGLE_MARKET';
export const UPDATE_SINGLE_MARKET = 'UPDATE_SINGLE_MARKET';
export const UPDATE_USER_MARKET_LIST = 'UPDATE_USER_MARKET_LIST';
